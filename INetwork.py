...
parser.add_argument("--num_iter", dest="num_iter", default=1, type=int,
...
scale_img = style_reference_image_paths[0]
simg = cv2.imread(scale_img)
cv2.imshow("Style Image", simg)
...
for i in range(num_iter):
    ...
    cv2.imshow("Iteration "+str(i + 1), img)
